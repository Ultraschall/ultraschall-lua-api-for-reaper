...
Infilename="c:\\Ultraschall3_1-portable - Api\\UserPlugins\\ultraschall_api\\misc\\reaper-apihelp14.txt"
...
function contentindex()
  ...
  count=1
  FunctionList=FunctionList.."<h2><img src=\"gfx/reaper.png\"><br>Reaper Reascript-Api-Documentation 5.941 - \"I mean, it's one banana Michael. How much could it cost? 10 dollars?\"</h2><h3>The Functions Reference</h3><table style=\"font-size:10pt;\" width=\"100%\">"
  while B[count]~=nil do
    count2=1
    local tud=1
