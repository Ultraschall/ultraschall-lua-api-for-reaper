...
Infilename="c:\\ultraschall_functions_engine.txt"
Outfile="c:\\ultraschall_functions_engine.html"
...
function contentindex()
  ...
  count=1
  FunctionList=FunctionList.."<h2><img src=\"/gfx/reaper.png\"><br>Reaper Reascript-Api-Documentation 5.92 - \"If it breaks, Kenny broke it\"</h2><h3>The Functions Reference</h3><table style=\"font-size:10pt;\" width=\"100%\">"
  while B[count]~=nil do
    count2=1
    local tud=1
...
-- Functioncalls
  ...
  for i=1, A do
    ...
    if temp~=nil then B[i][1]=string.gsub(B[i][1],temp:sub(1,-2).."%(","<b>"..temp.."</b>") end
  ...
  FunctionList=FunctionList.."<div style=\"padding-left:4%;font-size:100%\">\n"..cpp.."\n"..eel.."\n"..lua.."\n"..python.."</div>\n"
  cpp=""
  eel=""
  lua=""
  python=""
...
-- Retvals
  ...
  if index<Ccount then 
    ...
    if b>=10 then 
      reaper.ClearConsole() 
      reaper.ShowConsoleMsg("Processing entry:"..index.." of "..Ccount.." - "..C[index][1])
      b=0
    else 
      b=b+1
    end
