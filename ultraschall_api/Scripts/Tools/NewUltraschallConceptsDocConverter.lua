...
Ultraschall API functions
    ...
    <hr style="position:absolute; top:14%; left:15.1%; width:80.0%; color:#ffffff;">
        <div style="background-color:#282828;width:95%; font-family:tahoma; font-size:16;">
           ...
           <table border="0" style="color:#aaaaaa; width:45%;">
                ...
                <tr>
                    <td></td>
                    <td style="background-color:#555555; color:#BBBBBB; border: 1px solid #333333; border-radius:5%/5%;"><a href="US_Api_Documentation.html" style="color:#BBBBBB; text-decoration: none;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Functions Reference&nbsp;</a></td>
                </tr>
                <tr><td></td><tr>
                </table>
           </div>
...
function contentindex()
  ...
  count=1
  FunctionList=FunctionList.."<br><br><img src=\"gfx/us.png\"><div style=\"padding-left:0%;\"><br>"..beta.." \"John Cage - 4\'33\" - "..date.." - Build: "..build.."</div><h3>Introduction and Concepts</h3><table style=\"font-size:10pt; width:100%;\" >"
  while B[count]~=nil do
    count2=1
    local tud=1
...
--  FunctionArrayCounter=FunctionArrayCounter+1
  ...
  elseif kuddel==nil then
    FunctionList=FunctionList.."<br><hr><table width=\"100%\"><td style=\"position:absolute; right:0;\">Automatically generated by Ultraschall-API 4.00 "..beta..Ccount.." functions available</td></table><br><hr></div></body></html>"
    reaper.ShowConsoleMsg("\nSave File\n")
