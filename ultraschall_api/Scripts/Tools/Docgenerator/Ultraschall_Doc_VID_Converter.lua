...
Infilename=ultraschall.Api_Path.."/ultraschall_video_engine.lua"
Infilename2=ultraschall.Api_Path.."/ultraschall_video_engine_beta.lua"
Outfile=ultraschall.Api_Path.."/Documentation/US_Api_VID.html"
         ...
         <img alt="" style="width:6.9%; position: absolute; left:68.8%;" src="gfx/linedance.png">
           ...
           <table border="0" style="color:#aaaaaa; width:100%;">
                ...
                <tr>
                    ...
                    <td style="background-color:#777777; color:#BBBBBB; border: 1px solid #333333; border-radius:5%/5%;"><a href="US_Api_VID.html" style="color:#BBBBBB; text-decoration: none; justify-content: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Functions&nbsp;</a></td>
...
function contentindex()
  FunctionList=FunctionList.."<br><br><img src=\"gfx/us.png\"><div style=\"padding-left:0%;\"><br>"..beta.." - "..Tagline.." - "..date.." - Build: "..build.."</div><h3>Functions Reference</h3><table style=\"font-size:10pt; width:100%;\" >"
  reaper.ClearConsole()
...
-- Slug as HTML-Anchor
  if C[index]~=nil then
    ...
    --end
     ...
     else writefile() reaper.SetExtState("ultraschall", "doc", reaper.time_precise(), false) 
     end
end
