...
--reaper.MB(FunctionList2:match(".....180."), "", 0)
      FunctionList=FunctionList.."<br><hr><table width=\"100%\"><td style=\"position:absolute; right:0;\">Automatically generated by Ultraschall-API "..version.." "..beta.." - "..func_done_count.." functions and "..(Ccount-func_done_count-8).." Api-variables available</td></table><br><hr></div></body></html>"
